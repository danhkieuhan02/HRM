    ...
    <div class="container mt-5">
        <div class="card shadow-lg" style="border: none; border-radius: 15px; overflow: hidden;">
            <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #4e73df 0%, #224abe 100%);">
                <h4 class="card-title mb-0 fw-bold">Chỉnh sửa nhân viên</h4>
            </div>
            <div class="card-body bg-light p-4">
                <form action="{{ route('admin.employees.update', $employee->employee_code) }}" method="POST"
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input disabled type="text" class="form-control rounded-pill" id="employee_code"
                                name="employee_code" maxlength="20" value="{{ $employee->employee_code }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill" id="full_name" name="full_name"
                                maxlength="100" value="{{ $employee->full_name }}" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            @if ($employee->image)
                                <div class="mt-2">
                                    <img src="{{ asset($employee->image) }}" alt="Employee Image"
                    ...
                    <!-- Thông tin liên hệ và nguồn gốc -->
                    <h5 class="mt-5 mb-3 text-primary fw-semibold">Thông tin liên hệ và nguồn gốc</h5>
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill" id="phone_number" name="phone_number"
                                maxlength="15" value="{{ $employee->phone_number }}">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill" id="hometown" name="hometown"
                                maxlength="255" value="{{ $employee->hometown }}">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill" id="ethnic" name="ethnic"
                                maxlength="50" value="{{ $employee->ethnic }}">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill" id="status" name="status"
                                maxlength="20" value="{{ $employee->status }}">
                        </div>
                    </div>
                            ...
                            <select class="form-select rounded-pill" id="employee_position_code"
                                ...
                                @foreach ($employee_positions as $position)
                                    <option value="{{ $position->employee_position_code }}"
                                        {{ $employee->employee_position_code == $position->employee_position_code ? 'selected' : '' }}>
                            ...
                            <select class="form-select rounded-pill" id="contract_code" name="contract_code">
                                ...
                                @foreach ($contracts as $contract)
                                    <option value="{{ $contract->contract_code }}"
                                        {{ $employee->contract_code == $contract->contract_code ? 'selected' : '' }}>
                            ...
                            <select class="form-select rounded-pill" id="education_level_code"
                                ...
                                @foreach ($education_levels as $educationLevel)
                                    <option value="{{ $educationLevel->education_level_code }}"
                                        {{ $employee->education_level_code == $educationLevel->education_level_code ? 'selected' : '' }}>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title mb-0">Chỉnh sửa nhân viên</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.employees.update', $employee->employee_code) }}" method="POST"
                    enctype="multipart/form-data">
                    ...
                    <!-- Thông tin cơ bản -->
                    <h4 class="mt-2 mb-3">Thông tin cơ bản</h4>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="employee_code" class="form-label">Mã nhân viên <span
                                    class="text-danger">*</span></label>
                            <input disabled type="text" class="form-control" id="employee_code" name="employee_code"
                                maxlength="20" value="{{ $employee->employee_code }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            @if ($employee->image)
                                <img src="{{ asset($employee->image) }}" alt="Employee Image" class="img-thumbnail mt-2"
                                    width="150">
                            @endif
                        </div>
                    </div>
                    ...
                    <!-- Thông tin liên hệ và nguồn gốc -->
                    <h4 class="mt-4 mb-3">Thông tin liên hệ và nguồn gốc</h4>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <!-- Thông tin công việc -->
                    <h4 class="mt-4 mb-3">Thông tin công việc</h4>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="department_code" class="form-label">Phòng ban</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="employee_position_code" class="form-label">Chức vụ</label>
                            <select class="form-select" id="employee_position_code" name="employee_position_code">
                                <option value="">Chọn chức vụ</option>
                                @foreach ($employee_positions as $position)
                                    <option value="{{ $position->employee_position_code }}"
                                        {{ $employee->employee_position_code == $position->employee_position_code ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="contract_code" class="form-label">Hợp đồng</label>
                            <select class="form-select" id="contract_code" name="contract_code">
                                <option value="">Chọn hợp đồng</option>
                                @foreach ($contracts as $contract)
                                    <option value="{{ $contract->contract_code }}"
                                        {{ $employee->contract_code == $contract->contract_code ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="education_level_code" class="form-label">Trình độ học vấn</label>
                            <select class="form-select" id="education_level_code" name="education_level_code">
                                <option value="">Chọn trình độ học vấn</option>
                                @foreach ($education_levels as $educationLevel)
                                    <option value="{{ $educationLevel->education_level_code }}"
                                        {{ $employee->education_level_code == $educationLevel->education_level_code ? 'selected' : '' }}>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('admin.employees.index') }}" class="btn btn-outline-secondary">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
