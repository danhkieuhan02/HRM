...
return [
    ...
    | bởi lớp trình xác thực. Một số quy tắc có nhiều phiên bản như quy tắc
    | kích thước. Hãy thoải mái chỉnh sửa các thông báo này tại đây.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Tại đây bạn có thể chỉ định các thông báo xác thực tùy chỉnh cho các
    | thuộc tính bằng cách sử dụng quy ước "attribute.rule" để đặt tên cho
    | các dòng. Điều này giúp nhanh chóng chỉ định một thông báo tùy chỉnh
    | cho một quy tắc thuộc tính cụ thể.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau đây được sử dụng để thay thế trình giữ chỗ thuộc
    | tính của chúng tôi bằng một cái gì đó thân thiện hơn với người đọc
    | chẳng hạn như "Địa chỉ Email" thay vì "email". Điều này giúp chúng tôi
    | làm cho thông báo của mình biểu cảm hơn.
    |
    */
